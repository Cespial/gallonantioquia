    ...
    <section className="border-t border-borde/50 mb-12 md:mb-16">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="pt-3 md:pt-4">
          <FadeIn>
            <Link href="/sobre" className="group relative block aspect-[16/7] md:aspect-[21/9] overflow-hidden">
              <Image
              ...
              <div className="absolute bottom-0 left-0 p-6 md:p-8">
                <h3 className="font-display text-xl md:text-2xl text-white group-hover:text-dorado-tierra transition-colors">Mi historia</h3>
