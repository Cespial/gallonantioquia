  ...
  return (
    <section aria-label="Obras de infraestructura en Antioquia" className="bg-white">
      <div className="mx-auto max-w-[1500px] px-5 py-10 lg:px-8 lg:py-12">
        <ul className="grid grid-cols-2 gap-3 lg:grid-cols-12 lg:grid-rows-[14rem_18rem] lg:gap-4">
          {OBRAS.map((obra) => (
