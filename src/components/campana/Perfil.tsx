  ...
  return (
    ...
    >
          ...
          <div className="pb-8 pt-10 lg:pb-5 lg:pt-9">
            ...
            <div className="relative z-10 flex flex-wrap items-end gap-x-5 gap-y-2">
              <h2
                ...
                className="font-campana uppercase leading-[0.95]"
              >
            ...
            <ul className="mt-8 space-y-5 font-campana text-[0.95rem] leading-[1.5] text-neutral-700 lg:mt-9 lg:text-[0.9rem] lg:leading-[1.4]">
      ...
      <Image
        ...
        height={647}
        sizes="200px"
        className="pointer-events-none absolute right-0 top-0 hidden w-24 lg:block xl:w-28"
      />
      ...
      <div className="rounded-tr-[2.5rem] bg-campana-selva lg:rounded-tr-[3.5rem]">
        <div className="mx-auto max-w-[1500px] px-5 lg:px-8">
          <div className="lg:grid lg:grid-cols-2">
            <div aria-hidden="true" className="hidden lg:block" />
            <ul className="space-y-5 py-10 font-campana text-[0.95rem] leading-[1.5] text-white lg:py-6 lg:text-[0.9rem] lg:leading-[1.4]">
