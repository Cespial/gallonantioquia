...
export default function Valores() {
  return (
    <section className="bg-white pb-12 lg:pb-14" aria-label="Principios de la campaña">
      <ul className="mx-auto grid max-w-[1400px] gap-4 px-5 sm:grid-cols-2 lg:grid-cols-4 lg:px-10">
        {VALORES.map(({ icono: Icono, titulo, detalle }) => (
          <li
            key={titulo}
            className="flex items-center gap-4 rounded-2xl border border-neutral-200 bg-white px-5 py-5 shadow-[0_1px_3px_rgba(0,0,0,0.04)]"
          >
