...
export default function Pie({
  ...
  return (
    <footer className="bg-campana-profundo pt-7">
      ...
      <div className="mx-auto grid w-[min(76.875rem,100%_-_2.5rem)] gap-8 pb-5 lg:grid-cols-[0.85fr_1.7fr_1fr]">
        <div>
          <Image
      ...
      <div className="border-t border-white/15">
        <div className="mx-auto flex w-[min(76.875rem,100%_-_2.5rem)] flex-col gap-3 py-4 font-campana text-xs text-white/60 sm:flex-row sm:items-center sm:justify-between">
