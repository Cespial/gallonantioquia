...
export default function PlanDeGobierno({ ejes }: { ejes: EjeGobierno[] }) {
  return (
    <div className="bg-campana-bosque px-5 py-14 lg:px-12 lg:py-16">
          ...
          {ejes.map((eje) => (
            <li key={eje.slug}>
              <Link
                ...
                className="flex h-full flex-col items-center justify-center gap-3 rounded-2xl border border-white/25 px-3 py-7 text-center transition-colors hover:border-white/70 hover:bg-white/5"
              >
