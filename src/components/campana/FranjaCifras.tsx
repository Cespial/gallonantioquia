...
export default function FranjaCifras({
  ...
  return (
    ...
    >
      ...
      />
      <div aria-hidden="true" className="absolute inset-0 bg-campana-profundo/88" />

      <div className="relative mx-auto grid max-w-[76.875rem] items-center gap-9 px-5 py-10 lg:grid-cols-[1.32fr_0.68fr] lg:gap-8 lg:px-0 lg:py-4">
